...
function install(props) {
  ...
  return (
    <>
            ...
            <Card.Text>
              ...
              <b>
                <a href={info.source1} rel="noopener noreferrer" target="_blank">
                  US installation files
                </a>
              </b>{' '}
              (get all of them).
              <br />
              Extract the files first by executing the "FFXIFullSetup_US.part1.exe" then proceed to the installation through "FFXISetup.exe" (freshly
              extracted).
            </Card.Text>
            <Card.Text>
              ...
              <ul>
                ...
                <li>
                  On the next screen, enter id like 1234ABCD or ABCD1234 (4 letters 4 numbers it doesn't care about the order, doesn't matter if they're
                  accurate or not) in the "Member Name" and "PlayOnline ID" fields. If you wish to use your retail or trial account, you can input that.
                </li>
      ...
      <Row className="mb-3">
        <Col>
          <InfoDisplay title="Connecting to Retail">
            <Card.Text>
              To be capable of connecting to the Kraken server, you must be able to update your local install of Final Fantasy XI.
              <br />
              ...
              <ul>
                ...
                <li>
                  <b>
                    <a href={info.source1} rel="noopener noreferrer" target="_blank">
                      Activate a trial account provided by SquareEnix
                    </a>
                  </b>
                  <br />
                  When you do so, you will be emailed an activation key. This key may be used like a normal activation key.
                </li>
              </ul>
            </Card.Text>
          </InfoDisplay>
      ...
      <Row className="mb-3">
        <Col>
          <InfoDisplay title="Client Updates">
            <Card.Text>
              After having connected to retail at least once since installing Final Fantasy XI, you may then update it at any time by deleting a file on your
              local installation and using "Check Files" from the PlayOnline Viewer.
              <br />
              ...
              <ul>
                ...
                <li>
                  ...
                  <br />
                  Be sure that you are checking Final Fantasy XI and not the PlayOnline Viewer.
                </li>
                <li>
                  If Final Fantasy XI is not an option available in the drop-down menu from the "Check Files" menu, you have not connected to retail since
      ...
      <Row className="mb-3">
        <Col>
          <InfoDisplay title="Launcher Config">
            <Card.Text>
              After confirming that your client can connect to a server, you can use one of the popular third-party launchers for ease-of-use and additional
              features.
              <br />
              ...
              <ul>
                ...
                <code>--server krakenxi.ddns.net --user Username --pass Password</code>
      ...
      <Row className="mb-3">
        <Col>
          <InfoDisplay title="Recommended Downloads">
            <Card.Text>
              These are recommended for play on the Kraken server:
              <ul>
                <li>Add the Renamer Addon to your Windower/Ashita app.</li>
                <li>
                  Download the Kraken list from{' '}
                  <b>
                    <a href={info.source2} rel="noopener noreferrer" target="_blank">
                      here
                    </a>
                  </b>{' '}
                  and place into your Renamer/lists directory of Windower/Ashita.
                </li>
                <li>For Windower go to your Windower/scripts/ini.txt add these lines.</li>
                <code>
                  lua load renamer
                  <br />
                  renamer load kraken
                </code>
                <li>For Ashita go to your Ashita/scripts/default.txt add these lines.</li>
                <code>
                  /addon load renamer
                  <br />
                  /renamer load kraken
                </code>
                <li>Save and your ready to play!</li>
              </ul>
            </Card.Text>
          </InfoDisplay>
        </Col>
      ...
      <Row className="mb-3">
        <Col>
          <InfoDisplay title="Make it Beautiful">
            <Card.Text>
              <ReactPlayer url="https://www.youtube.com/watch?v=ADjRYUdSyXA" />
              <br />
              <b>Note: When using DgVooDoo with Windower or Ashita, copy the files to the Windower directory or the Ashita ffxiboot folder.</b>
            </Card.Text>
          </InfoDisplay>
        </Col>
      </Row>
